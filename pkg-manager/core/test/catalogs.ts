...
describe('add', () => {
  ...
  test('adding with useCatalog: always will add to or use from catalog', async () => {
    const { options, projects, readLockfile } = preparePackagesAndReturnObjects([{
      name: 'project1',
      dependencies: {},
    }])
  ...
  test('adding with useCatalog: prefer will add to or use from catalog', async () => {
    const { options, projects, readLockfile } = preparePackagesAndReturnObjects([{
      name: 'project1',
      dependencies: {},
    }])
  ...
  test('adding mismatched version with useCatalog: always will error', async () => {
    const { options, projects } = preparePackagesAndReturnObjects([{
      name: 'project1',
      dependencies: {
        'is-positive': 'catalog:',
  ...
  test('adding mismatched version with useCatalog: prefer will warn and use direct', async () => {
    const { options, projects, readLockfile } = preparePackagesAndReturnObjects([{
      name: 'project1',
      dependencies: {
        'is-positive': 'catalog:',
